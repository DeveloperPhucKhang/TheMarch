        ...
        success: function (result) {
            ...
            if (result.result == 'success') {
                ...
                for (var i = 0; i < result.list_event_recently.length; i++) {
                    html += '<li>' +
                                '<div class="thumb"><a href="/home/detail_event/' + result.list_event_recently[i]._id + '"><img src="/' + result.list_event_recently[i].thumbnail + '" alt="' + result.list_event_recently[i].title + '"/></a></div>' +
                                '<div class="w-desk">' +
